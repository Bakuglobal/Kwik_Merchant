...
var ProductsPage = /** @class */ (function () {
    function ProductsPage(navCtrl, service, asc, scannner, http, db, camera, formBuilder, modal, upload, file, loader, load, storage, ref, webview, fs, imagePicker, cropService, fileChooser) {
        var _this = this;
        ...
        this.service.getallcategories(this.db.getshopname()).valueChanges().subscribe(function (res) {
    ...
    ProductsPage.prototype.getproducts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fs.collection(this.shop).valueChanges().subscribe(function (res) {
                            console.log(res);
                            _this.products = res;
    ...
    ProductsPage.prototype.scan = function () {
        ...
        this.scannner.scan().then(function (code) {
            ...
            _this.scannedcode = code.toString();
        });
    };
    ...
    ProductsPage.prototype.createButtons = function () {
        ...
        var _loop_1 = function (index) {
            var button = {
                text: this_1.categories.categories[index].name,
                // icon: this.Allcategories[index].icon,
                handler: function () {
                    console.log('button text ' + _this.categories.categories[index].name);
                    _this.value = _this.categories.categories[index].name;
                    return true;
                }
            };
            buttons.push(button);
...
var UploadService = /** @class */ (function () {
    function UploadService(navCtrl, asc, http, 
    ...
    UploadService.prototype.presentToast = function (text) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toasted;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        toasted = _a.sent();
                        return [4 /*yield*/, toasted.present()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UploadService.prototype.uploadImage = function (imageURI) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var storageRef = _this.Firestorage.storage.ref();
    ...
    UploadService.prototype.encodeImageUri = function (imageUri, callback) {
