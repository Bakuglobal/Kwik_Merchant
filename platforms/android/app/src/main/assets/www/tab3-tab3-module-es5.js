...
var Tab3Page = /** @class */ (function () {
    function Tab3Page(navCtrl, modalCtrl, fileChooser, filePath, asC, storage, database, camera, service) {
    ...
    Tab3Page.prototype.infoModal = function (url) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    Tab3Page.prototype.pickFile = function (value) {
        var _this = this;
        if (value === 'image') {
            // pick images
            var options = {
