...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.canActivate = function (route) {
        ...
        var logs = localStorage.getItem('user');
        console.log(logs);
        if (logs != null) {
            return true;
        }
...
var routes = [
    {
        ...
        children: [
            ...
            // tslint:disable-next-line: max-line-length
            { path: 'products', loadChildren: function () { return Promise.all(/*! import() | products-products-module */[__webpack_require__.e("common"), __webpack_require__.e("products-products-module")]).then(__webpack_require__.bind(null, /*! ../products/products.module */ "./src/app/products/products.module.ts")).then(function (m) { return m.ProductsPageModule; }); }, canActivate: [_Auth_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]] },
            {
                // tslint:disable-next-line: max-line-length
...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage.prototype.ionViewWillEnter = function () {
        ...
        ;
        this.signal.notice.subscribe(function (res) {
            _this.count = res;
        });
