...
const routes = [
    {
        ...
        children: [
            ...
            // tslint:disable-next-line: max-line-length
            { path: 'products', loadChildren: () => __webpack_require__.e(/*! import() | products-products-module */ "products-products-module").then(__webpack_require__.bind(null, /*! ../products/products.module */ "./src/app/products/products.module.ts")).then(m => m.ProductsPageModule), canActivate: [_Auth_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]] },
            {
                // tslint:disable-next-line: max-line-length
